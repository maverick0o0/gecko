...
## Step 3 – Restore the prebuilt signed add-on (optional)

If you just need the signed artifact that lives in the repository, convert the Base64 source into a real `.xpi`:
...
## Step 5 – Sign the bundle for permanent installation
...
## Step 6 – Install the signed add-on in Firefox
